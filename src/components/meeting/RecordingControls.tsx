...
export default function RecordingControls({
  ...
  return (
    <div className="rounded-xl border border-zinc-700/60 bg-zinc-900/80 px-3 py-2 text-xs shadow-lg backdrop-blur">
      <div className="flex items-center gap-3">
        ...
        <button
          ...
          disabled={isMutating}
          className="rounded-lg border border-zinc-600 bg-zinc-800 px-2.5 py-1 text-xs font-medium text-zinc-50 hover:bg-zinc-700 disabled:cursor-not-allowed disabled:opacity-60"
        >
      ...
      <div className="mt-1 space-y-1">
        ...
        {downloadUrl && (
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-block text-[11px] font-medium text-blue-400 underline hover:text-blue-300"
          >
            Download recording
          </a>
        )}
